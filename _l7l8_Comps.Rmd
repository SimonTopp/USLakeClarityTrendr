...
ls78 <- files %>%
  ...
  mutate(hue = rgb2hsv(r=red, g=green, b=blue, maxColorValue = 2000)[1],
         saturation = rgb2hsv(r=red, g=green, b=blue, maxColorValue = 2000)[2],
...
library(plotly)
ggplotly(ggplot(ls78_wide %>% filter(band == 'fui.hue'), aes(x = l7, y = l8, color = ID)) + geom_point() + geom_abline())
