...
layout <- rbind(c(1,1,1), c(1,1,1),c(1,1,1),c(2,2,2),c(2,2,2),c(3,3,NA), c(3,3,NA),c(4,4,NA), c(4,4,NA))
g <- grid.arrange(p1,p2,p3,p4, layout_matrix = layout)

ggsave('figures/ValidationBreakDown.png', width = 5.5, height = 9.5, units = 'in', plot = g)
