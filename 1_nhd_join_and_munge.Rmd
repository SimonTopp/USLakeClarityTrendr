...
lsComps <- read_feather('out/srMunged.feather') %>%
...
lsComps %>% filter(year > 1999, year < 2012) %>% gather(red, blue, green, nir, NR, BG, dWL, key = 'Band', value = 'value') %>%
...
lsComps %>% filter(year > 2012) %>% gather(red, blue, green, nir, NR, BG, dWL, key = 'Band', value = 'value') %>%
  ggplot(., aes(x = value, color = sat)) + geom_density() + facet_wrap(~Band, scales = 'free') 
...
lsComps %>% filter(year > 2012) %>% gather(red, blue, green, nir, NR, BG, dWL, key = 'Band', value = 'value') %>%
  ggplot(., aes(x = value, color = sat)) + geom_density() + facet_wrap(~Band, scales = 'free') 
#Overall
lsComps %>% gather(red, blue, green, nir, NR, BG, dWL, key = 'Band', value = 'value') %>%
  ggplot(., aes(x = value, color = sat)) + geom_density() + facet_wrap(~Band, scales = 'free') 
