...
```{r}
files <- drive_ls('aquaModel_lakesEcoReg2000_nemer88')
files <- files %>% filter(!name %in% list.files('lake_data/EcoReg2000'))

for(i in c(1:nrow(files))){
  path <- paste0('lake_data/EcoReg2000/',files$name[i])
